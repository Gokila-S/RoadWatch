...
const MOCK_REPORTS = [
  ...
  },
  {
    ...
    assignedTo: null,
    aiConfidence: 76,
    images: ['/placeholder-sinkhole.jpg'],
...
const DISTRICTS = [
  { id: 'north', name: 'Bangalore North', admin: 'Rajesh Kumar', totalIssues: 156, resolved: 134, pending: 12, assigned: 10, avgResolution: '4.2 days' },
  { id: 'south', name: 'Bangalore South', admin: 'Sunita Devi', totalIssues: 203, resolved: 178, pending: 15, assigned: 10, avgResolution: '3.8 days' },
  { id: 'east', name: 'Bangalore East', admin: 'Mohammed Salim', totalIssues: 187, resolved: 152, pending: 18, assigned: 17, avgResolution: '5.1 days' },
  { id: 'central', name: 'Bangalore Central', admin: 'Preethi Rao', totalIssues: 142, resolved: 125, pending: 8, assigned: 9, avgResolution: '3.2 days' },
  { id: 'west', name: 'Bangalore West', admin: 'Ganesh Hegde', totalIssues: 98, resolved: 89, pending: 5, assigned: 4, avgResolution: '2.9 days' },
]
...
const useStore = create((set, get) => ({
  ...
  login: (role) => {
    const users = {
      citizen: { id: 'citizen_001', name: 'Priya Sharma', email: 'priya@example.com', role: 'citizen', district: 'Bangalore North' },
      admin: { id: 'admin_north', name: 'Rajesh Kumar', email: 'rajesh@roadwatch.gov', role: 'admin', district: 'Bangalore North' },
